...
export const DEFAULT_MERCHANT_RULES: Omit<MerchantRule, 'id' | 'userId' | 'createdAt'>[] = [
  ...
  { pattern: 'SLICE|SLICEPAY|SIMPL|GETSIMPL|LAZYPAY|SNAPMINT|FREO|FREOPAY|MONEYTAP|ZESTMONEY|AMAZON PAY LATER|FLIPKART PAY LATER', merchantName: 'Buy Now Pay Later (BNPL)', categoryId: 'cat_financial', subcategoryId: 'sub_emi_personal', defaultType: 'DEBT_PAYMENT', confidenceScore: 0.98, isRegex: true },
