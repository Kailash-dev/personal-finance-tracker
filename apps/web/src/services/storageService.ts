  ...
  private initDefaults() {
    ...
    const EXACT_USER_DEBTS: Debt[] = [
      ...
      },
      {
        ...
        cardAccountStatus: 'ACTIVE' as const,
        originalAmount: 25000,
        outstandingAmount: 25000,
        monthlyEmi: 5000,
        minimumDueAmount: 5000,
      ...
      },
      {
        ...
        monthlyEmi: 12108,
        totalDueAmount: 38000,
        minimumDueAmount: 12108,
        creditLimit: 50000,
        interestRate: 42.0,
        totalTenureMonths: 4,
        emisPaid: 1,
        ...
        dueDay: 28,
        notes: 'SBI Credit Card — ACTIVE. MAD ₹12,108. Full outstanding ₹38,000. Due 28th.',
        createdAt: new Date().toISOString(),
        updatedAt: new Date().toISOString(),
      },
      {
        ...
        type: 'CREDIT_CARD_MIN_PAYMENT',
        cardAccountStatus: 'SETTLEMENT_EMI' as const,
        settlementTotalAmount: 4200,
        originalAmount: 4200,
        ...
        dueDay: 15,
        notes: 'Settlement agreed at ₹4,200 for 3 installments of ₹1,400. 2 paid. 1 remaining in Sept — closes card forever!',
        createdAt: new Date().toISOString(),
        updatedAt: new Date().toISOString(),
      },
