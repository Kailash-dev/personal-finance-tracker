  ...
  private initDefaults() {
    ...
    const EXACT_USER_DEBTS: Debt[] = [
      ...
      },
      {
        id: 'debt_nbfc_loan',
        userId: 'user_kailash',
        name: 'NBFC FinTech Loan (KreditBee / MoneyView / Navi)',
        lender: 'NBFC Lender',
        type: 'NBFC_LOAN',
        ...
        startDate: '2026-09-01',
        dueDay: 5,
        notes: 'NBFC short-term loan yet to pay (Edit values to match exact statement)',
        createdAt: new Date().toISOString(),
        updatedAt: new Date().toISOString(),
      },
      {
        id: 'debt_bnpl_dues',
        userId: 'user_kailash',
        name: 'Buy Now Pay Later (LazyPay / Simpl / Amazon)',
        lender: 'BNPL Provider',
        type: 'BNPL',
        ...
        startDate: '2026-09-01',
        dueDay: 20,
        notes: 'BNPL dues yet to pay (Edit values to match exact statement)',
        createdAt: new Date().toISOString(),
        updatedAt: new Date().toISOString(),
      },
    ];

    const USER_CONFIG_KEY = 'rupeetrack_user_exact_debts_v9';
